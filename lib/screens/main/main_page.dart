...
String selectedTimeline = 'Best of this week';
...
class _MainPageState extends State<MainPage>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          title: Text('Computer Hardware Store'),
          backgroundColor: Color(0xFFf8b94c),
          actionsIconTheme:
              IconThemeData(size: 30.0, color: Colors.black, opacity: 10.0),
          leading: IconButton(
            icon: new Icon(Icons.home, color: Colors.white),
            onPressed: () => bottomTabController.animateTo(0),
          ),
          actions: <Widget>[
            IconButton(
              icon: new Icon(Icons.doorbell, color: Colors.white),
            ...
            IconButton(
              icon: new Icon(Icons.checklist, color: Colors.white),
              onPressed: () => bottomTabController.animateTo(1),
            ),
            IconButton(
              icon: new Icon(Icons.payment, color: Colors.white),
              onPressed: () => bottomTabController.animateTo(2),
            ),

            IconButton(
              icon: new Icon(Icons.person, color: Colors.white),
              onPressed: () => bottomTabController.animateTo(3),
            )
          ]),
      body: CustomPaint(
